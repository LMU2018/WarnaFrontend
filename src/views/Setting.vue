...
white-space: nowrap;">
            ...
            <div class="modal-body">
              <div class="form-group">
                <div class="form-group row">
                  <label for="inputEmail3" style="font-size:12px" class="text text-left col-sm-3 col-form-label"><b>NAME </b></label>
                  <div class="col-sm-9">
                    <input
                ...
                <div class="form-group row">
                  <label for="npm" style="font-size:12px" class="text text-left col-sm-3 col-form-label"><b>NPM </b></label>
                  <div class="col-sm-9">
                    <input
                      minlength="5"
                ...
                <div class="form-group row">
                  <label for="npm" style="font-size:12px" class="text text-left col-sm-3 col-form-label"><b>EMAIL</b></label>
                  <div class="col-sm-9">
                    <input
                ...
                <div class="form-group row">
                  <label for="npm" style="font-size:12px" class="text text-left col-sm-3 col-form-label"><b>RESET PASSWORD</b></label>
                  <div class="col-sm-9">
                    <input
                      v-model="newPassword"
                      type="password"
                ...
                <div class="form-group row">
                  <label for="npm" style="font-size:12px" class="text text-left col-sm-3 col-form-label"><b>OUTLET</b></label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row">
                  <label for="npm" style="font-size:12px" class="text text-left col-sm-3 col-form-label"><b>PRIVILEGES</b></label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row">
                  <label style="font-size:12px" class="text text-left col-sm-3 col-form-label"><b>STATUS</b></label>
                  <div class="col-sm-9">
                    <select v-show="cb" v-model="DetailUsersStatus" class="form-control form-control-sm">
                      <option disabled value>Pilih Status</option>
                      <option v-for="s in arrayStatus" v-bind:value="s.id">{{ s.name }}</option>
                    </select>
                    <select v-show="ho" v-model="DetailUsersStatus" class="form-control form-control-sm">
                      <option disabled value>Pilih Status</option>
    ...
    <div class="modal fade" id="create_account">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="#" v-on:submit.prevent="add_users">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <div class="modal-body">
              <div class="form-group row">
                <label for="npm" style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>NPM</b></label>
                <div class="col-sm-10">
                  <input
                    type="text"
                    class="form-control form-control-sm"
                    ...
                    v-model="npm"
                    required
                    oninvalid="this.setCustomValidity('NPM Wajib Di isi')"
              ...
              <div class="form-group row">
                <label for="npm" style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>NAME</b></label>
                <div class="col-sm-10">
                  <input
                    type="text"
                    class="form-control form-control-sm"
                    ...
                    placeholder="example"
                    required
                    oninvalid="this.setCustomValidity('Nama Wajib Di isi')"
                    oninput="setCustomValidity('')"
                    autofocus
                  >
                </div>
              ...
              <div class="form-group row">
                <label for="npm" style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>EMAIL</b></label>
                <div class="col-sm-10">
                  <input
                    type="email"
                    class="form-control form-control-sm"
              ...
              <div class="form-group row">
                <label for="npm" style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>PASSWORD</b></label>
                <div class="col-sm-10">
                  <input
                    type="password"
                    class="form-control form-control-sm"
              ...
              <div class="form-group row">
                <label for="npm" style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>PHOTO</b></label>
                <div class="col-sm-10">
                  <input
                    type="file"
                    ...
                    required
                    oninvalid="this.setCustomValidity('Foto Wajib Di isi')"
                    oninput="setCustomValidity('')"
                    autofocus
                  >
                </div>
              ...
              <div v-show="ho" class="form-group row">
                <label for="npm" style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>CABANG</b></label>
                <div class="col-sm-10">
                  <div>
              ...
              <div v-show="ho" class="form-group row">
                <label style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>OUTLET</b></label>
                <div class="col-sm-10">
                  <select
                    v-model="outlet_id"
                    class="form-control form-control-sm"
              ...
              <div class="form-group row">
                <label style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>PRIVILEGES</b></label>
                <div class="col-sm-10">
                  <select
                    v-model="default_privilages"
                    class="form-control form-control-sm"
                    required
                    oninvalid="this.setCustomValidity('Privileges Wajib Di isi')"
                    oninput="setCustomValidity('')"
                    autofocus
                  >
              ...
              <div v-show="ho" class="form-group row">
                <label style="font-size:13px" class="text-left col-sm-2 col-form-label"><b>STATUS</b></label>
                <div class="col-sm-10">
                  <select
                    v-model="default_status"
                    class="form-control form-control-sm"
                    required
                    oninvalid="this.setCustomValidity('Status Wajib Di isi')"
                    oninput="setCustomValidity('')"
                    autofocus
                  >
                    <option disabled value>Pilih Outlet</option>
...
export default {
  ...
  methods: {
    ...
    async add_users() {
      ...
      if (this.post_data.api_status == 0) {
